-- BG Ammo Tweaks - 15 Ammo Cap (LightBowgun)
-- By LordGregory

local version = "1.3"
log.info("Initializing `BG Ammo Tweaks - 15 Ammo Cap (LightBowgun)` v"..version)
...
for baseIndex, entry in pairs(LightBowgunData) do
    if (entry._LightBowgun == 1) then
        entry._ShellNum[0] = 15
        entry._ShellNum[1] = 15
        entry._ShellNum[2] = 15
        entry._ShellNum[3] = 15
        entry._ShellNum[4] = 15
        entry._ShellNum[5] = 15
        entry._ShellNum[6] = 15
        entry._ShellNum[7] = 15
        entry._ShellNum[8] = 15
        entry._ShellNum[9] = 15
        entry._ShellNum[10] = 15
        entry._ShellNum[11] = 15
        entry._ShellNum[12] = 15
        entry._ShellNum[13] = 15
        entry._ShellNum[14] = 15
        entry._ShellNum[15] = 15
        entry._ShellNum[16] = 15
        entry._ShellNum[17] = 15
        entry._ShellNum[18] = 15
        entry._ShellNum[19] = 15
        entry:call("onLoad")
    end
