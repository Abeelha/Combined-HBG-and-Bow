-- BG Ammo Tweaks - Rapid Fire - 15 Ammo Cap (LightBowgun)
-- By LordGregory

local version = "1.3"
log.info("Initializing `BG Ammo Tweaks - Rapid Fire - 15 Ammo Cap (LightBowgun)` v"..version)
...
for baseIndex, entry in pairs(LightBowgunData) do
    if (entry._LightBowgun == 1) then
        entry._RapidShellNum[0] = 15
        entry._RapidShellNum[1] = 15
        entry._RapidShellNum[2] = 15
        entry._RapidShellNum[3] = 15
        entry._RapidShellNum[4] = 15
        entry._RapidShellNum[5] = 15
        entry._RapidShellNum[6] = 15
        entry._RapidShellNum[7] = 15
        entry._RapidShellNum[8] = 15
        entry._RapidShellNum[9] = 15
        entry._RapidShellNum[10] = 15
        entry._RapidShellNum[11] = 15
        entry._RapidShellNum[12] = 15
        entry._RapidShellNum[13] = 15
        entry._RapidShellNum[14] = 15
        entry._RapidShellNum[15] = 15
        entry._RapidShellNum[16] = 15
        entry._RapidShellNum[17] = 15
        entry._RapidShellNum[18] = 15
        entry._RapidShellNum[19] = 15
        entry:call("onLoad")
    end
