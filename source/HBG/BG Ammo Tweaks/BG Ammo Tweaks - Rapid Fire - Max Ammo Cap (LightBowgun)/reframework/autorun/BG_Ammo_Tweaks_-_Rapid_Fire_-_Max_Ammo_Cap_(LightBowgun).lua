-- BG Ammo Tweaks - Rapid Fire - Max Ammo Cap (LightBowgun)
-- By LordGregory

local version = "1.3"
log.info("Initializing `BG Ammo Tweaks - Rapid Fire - Max Ammo Cap (LightBowgun)` v"..version)
...
for baseIndex, entry in pairs(LightBowgunData) do
    if (entry._LightBowgun == 1) then
        entry._RapidShellNum[1] = 6
        entry._RapidShellNum[3] = 4
        entry._RapidShellNum[4] = 3
        entry._RapidShellNum[5] = 4
        entry._RapidShellNum[6] = 2
        entry._RapidShellNum[7] = 7
        entry._RapidShellNum[8] = 6
        entry._RapidShellNum[9] = 7
        entry._RapidShellNum[10] = 7
        entry._RapidShellNum[11] = 3
        entry._RapidShellNum[12] = 7
        entry._RapidShellNum[13] = 5
        entry._RapidShellNum[14] = 5
        entry._RapidShellNum[15] = 2
        entry._RapidShellNum[16] = 3
        entry._RapidShellNum[17] = 3
        entry._RapidShellNum[18] = 5
        entry._RapidShellNum[19] = 4
        entry:call("onLoad")
    end
